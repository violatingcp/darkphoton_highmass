...
GC_465 = Coupling(name = 'GC_465',
                 value = '(gd*eta*complex(0,1)*sa)/(6.*cw) - (ca*gd*complex(0,1)*sw)/(6.*cw)',
                 order = {'QED':1})

GC_466 = Coupling(name = 'GC_466',
                 value = '(ca*gd*complex(0,1))',
                 #value = 'complex(0,1)*gVXd',
                 order = {'QED':1})

GC_467 = Coupling(name = 'GC_467',
                 value = '-(gd*sa*eta*complex(0,1)) + (ca*gd*complex(0,1)) + (ca*gd*complex(0,1))',
                 order = {'QED':1})

GC_47 = Coupling(name = 'GC_47',
                 value = '-(ca*ee*eta*complex(0,1))/(2.*cw) - (sa*cw*ee*complex(0,1))/(2.*sw) - (sa*ee*complex(0,1)*sw)/(2.*cw)',
                 order = {'QED':1})

GC_471 = Coupling(name = 'GC_471',
                 value = '-(ca*gd*eta*complex(0,1)) - (sa*gd*complex(0,1)) - (sa*gd*complex(0,1))',
                 order = {'QED':1})
